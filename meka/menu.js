...
import { xpRange } from '../mxgamecoder/levelling.js';
            ...
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                        ...(await prepareWAMessageMedia({ image: { url: './meka-media/mx.jpg' } }, { upload: conn.waUploadToServer })),
                        title: null,
                        subtitle: null,
...
handler.help = ['main'];
handler.tags = ['group'];
handler.command = ['coder', 'help2', 'h', 'commands2'];
