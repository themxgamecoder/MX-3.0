import { smsg } from './mxgamecoder/simple.js';
...
export async function handler(chatUpdate) {
   ...
   */
    ...
    const ___dirname = path.join(path.dirname(fileURLToPath(import.meta.url)), './meka')
    ...
    try {
      if (!opts['noprint']) await (await import('./mxgamecoder/print.js')).default(m, this)
    } catch (e) {
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://i.ibb.co/tw4hKc9q/mx.png' // Assign default image URL
            ppgp = 'https://i.ibb.co/tw4hKc9q/mx.png' // Assign default image URL
          } finally {
