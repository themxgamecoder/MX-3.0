...
import { imageToWebp, videoToWebp, writeExifImg, writeExifVid } from '../mxgamecoder/exif.cjs';
import { getBuffer, getSizeMedia } from '../mxgamecoder/myfunc.cjs'
...
function serialize(m, sock, logger) {
  ...
  sock.sendMedia = async (jid, path, fileName = '', caption = '', quoted = '', options = {}) => {
    ...
    if (options.asSticker || /webp/.test(mime)) {
      let { writeExif } = require('./mxgamecoder/exif')
